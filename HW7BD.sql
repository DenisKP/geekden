...
INSERT INTO users_orders (name, order_id) VALUES ( 'Ãåííàäèé', 1), ( 'Ìèõàèë', 2), ( 'Åâãåíèé', 3), ( 'Ñâåòëàíà', NULL), ( 'Dmitriy', NULL);
...
INSERT INTO cities (label, name) VALUES ('moscow', 'Ìîñêâà'), ('irkutsk', 'Èðêóòñê'), ('novgorod', 'Íîâãîðîä'), ('kazan', 'Êàçàíü'), ('omsk', 'Îìñê');
SELECT
